  ...
  return (
    <div className="mx-8 min-h-[70vh] flex justify-center items-center sm:mx-16 xl:mx-24 relative">
     <div>
        ...
        <h1 className="text-5xl sm:text-6xl font-semibold text-gray-700 sm:leading-16">The Best <span className="text-primary">Authentication</span> <br /> System For SaaS Applications</h1>
